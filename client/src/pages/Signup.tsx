      ...
      >
        ...
        >
          <Box w="100%" maxW="380px" className={`fade-up ${visible ? "in" : ""}`}>
            ...
            >
              <GoogleIcon />
              <Text ml="2" fontFamily="'Outfit', sans-serif">Sign up with Google</Text>
            </Button>
            ...
            >
              ...
              <Link href="/terms" color="#8a867e" textDecoration="underline" _hover={{ color: "#c9a84c" }}>
                Terms
              </Link>
              {" "}and{" "}
              <Link href="/privacy" color="#8a867e" textDecoration="underline" _hover={{ color: "#c9a84c" }}>
                Privacy Policy
              </Link>
            </Text>
